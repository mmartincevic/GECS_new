...
class TextureManager {
    public:
        ...
        void DrawTile(std::string tilesetId, int width, int height, int x, int y, int srcx, int srcy, int frame, int rotation = 0, float ration = 1.0f, SDL_RendererFlip flip = SDL_FLIP_NONE);
